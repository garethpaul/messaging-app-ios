...
- The Make gates are location-independent. From another directory, pass the
  ...
  invocation is trusted locally. GNU Make 4.3 and newer preserve literal
  ...
  3.81 and GNU Make 4.2 expand Make syntax while loading the path, before
  repository rules can run, so do not invoke them with a checkout path
  containing Make syntax; move or rename the checkout, or use GNU Make 4.3+.
